...
const Navbar = () => {
  ...
  return (
    <div className=" w-full h-[100px] bg-white shadow flex justify-between items-center px-4 relative ">
      ...
      <div className={`h-[100px] bg-[#ffa704] absolute left-0 top-full z-50 flex justify-center items-center gap-20 text-primary font-bold transition-all duration-700 ${NavOpen ? 'w-full scale-100 opacity-100 max-lg:w-[50%] ' : 'w-0 xl:scale-0 opacity-0 select-none '} max-xl:gap-10 max-xl:h-[600px] max-xl:flex-col max-lg:items-end max-lg:pr-5 `}>
